-- Originally by Dango360, see `original/` directory. Slightly edited before started as a project.
...
allowed = function(url, parenturl)
  ...
  if string.match(url, "^https?://assetdelivery%.roblox%.com/v1/asset.*$")
...
wget.callbacks.finish = function(start_time, end_time, wall_time, numurls, total_downloaded_bytes, total_download_time)
  ...
  for key, data in pairs({
    ["roblox-assets-6q7hynukmjaufoq6"] = discovered_items,
